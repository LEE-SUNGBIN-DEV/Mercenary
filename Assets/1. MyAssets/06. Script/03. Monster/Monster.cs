...
{
    #region Event
    public static event UnityAction<Monster> onCurrentHitPointChanged;
    public static event UnityAction<Monster> onDie;
    #endregion

    [SerializeField] private MONSTER_POOL monsterPoolKey;
    ...
    {
        if (MonsterPoolManager.Instance.MonsterPoolDictionary.ContainsKey(monsterPoolKey))
        {
            MonsterPoolManager.Instance.ReturnObject(monsterPoolKey, gameObject);
        }
    }
    ...
    public void OutSpawn()
    {
        ...
        gameObject.tag = GameConstant.enemyTag;
    ...
    #region Property
    public MONSTER_POOL MonsterPoolKey
    {
        get { return monsterPoolKey; }
        private set { monsterPoolKey = value; }
    }
