...
public class CharacterStateMove : ICharacterState
{
    ...
    {
        verticalDirection.x = character.CharacterCamera.transform.forward.x;
        verticalDirection.z = character.CharacterCamera.transform.forward.z;

        horizontalDirection.x = character.CharacterCamera.transform.right.x;
        horizontalDirection.z = character.CharacterCamera.transform.right.z;
