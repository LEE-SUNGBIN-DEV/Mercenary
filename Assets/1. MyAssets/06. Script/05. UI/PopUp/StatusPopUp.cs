...
public class StatusPopUp : PopUp
{
    ...
    {
        if (GameManager.Instance.Player.PlayerData.StatPoint > 0)
        {
            --GameManager.Instance.Player.PlayerData.StatPoint;
            ++GameManager.Instance.Player.PlayerData.Strength;
        }
    }
    public void IncreaseVitality()
    {
        ...
        {
            --GameManager.Instance.Player.PlayerData.StatPoint;
            ++GameManager.Instance.Player.PlayerData.Vitality;
        }
    }
    ...
    public void IncreaseDexterity()
    {
        ...
        {
            --GameManager.Instance.Player.PlayerData.StatPoint;
            ++GameManager.Instance.Player.PlayerData.Dexterity;
        }
    }
    ...
    public void IncreaseLuck()
    {
        ...
        {
            --GameManager.Instance.Player.PlayerData.StatPoint;
            ++GameManager.Instance.Player.PlayerData.Luck;
        }
    }
    #endregion
