...
public class CharacterCamera : BaseCamera
{
    ...
    private void Start()
    {
        ...
        normalizedDirection = transform.localPosition.normalized;
        finalDistance = transform.localPosition.magnitude;
    }
    ...
    private void LateUpdate()
    {
        ...
        transform.localPosition = Vector3.Lerp(transform.localPosition, normalizedDirection * finalDistance, Time.deltaTime * Smoothness);
    }
